    ...
    return {
        ...
        "chat": {
            ...
            "features": [
                ...
                {"name": "Duplicate Detectie", "description": "Bij het uploaden worden bestandsnamen vergeleken met bestaande documenten in de collectie. Dubbele bestanden worden automatisch overgeslagen met 'Al aanwezig' status. Bij herhaald uploaden van dezelfde map worden alleen nieuwe bestanden verwerkt — bestaande documenten worden alsnog in de juiste mappenstructuur geplaatst."},
