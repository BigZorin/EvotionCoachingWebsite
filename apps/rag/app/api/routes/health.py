    ...
    return {
        ...
        "stability": {
            ...
            "features": [
                ...
                {"name": "HTML Tag Stripping", "description": "Stray HTML tags (p, br, div, span, etc.) in LLM-output worden driedubbel gefilterd: (1) system prompt verbiedt HTML, (2) server-side regex strip in chat_service voordat antwoord naar client gaat, (3) frontend strip als laatste fallback"},
