        ...
        <div className="bg-white rounded-xl border shadow-sm overflow-hidden">
          ...
          <div className="border-t px-4 py-3 flex gap-2">
            <input
              ...
              className="flex-1 px-4 py-2 text-sm border rounded-full focus:ring-2 focus:ring-[#1e1839]/20 focus:border-[#1e1839] outline-none"
            />
            <button
              onClick={handleSendMessage}
              disabled={!newMessage.trim() || sending}
              className="w-10 h-10 rounded-full bg-[#1e1839] text-white flex items-center justify-center hover:bg-[#2d2550] disabled:opacity-40 transition"
            >
          ...
          <div className="px-5 py-5 border-b flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 text-sm bg-[#1e1839] text-white rounded-lg hover:bg-[#2d2550] transition"
              >
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              {availableClients.length > 0 && (
                <button
                  ...
                  className="flex items-center gap-1.5 text-sm text-[#1e1839] hover:underline"
                >
            ...
            {showAddMembers && (
              <div className="mb-4 p-4 bg-gray-50 rounded-lg border">
                <div className="flex items-center justify-between mb-3">
                  <p className="text-sm font-medium text-gray-700">Selecteer clients</p>
                  ...
                  {availableClients.map((client) => (
                    ...
                    >
                      <input
                        ...
                        className="rounded border-gray-300 text-[#1e1839] focus:ring-[#1e1839]"
                      />
                      <span className="text-sm text-gray-700">{clientName(client)}</span>
                    </label>
                  ))}
                </div>
                <button
                  ...
                  className="px-4 py-2 text-sm bg-[#1e1839] text-white rounded-lg hover:bg-[#2d2550] disabled:opacity-40 transition"
                >
    ...
    return (
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl border shadow-sm p-6">
          <h2 className="text-xl font-bold text-gray-900 mb-6">Nieuwe Groep</h2>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-[#1e1839]/20 focus:border-[#1e1839] outline-none"
              />
            </div>
                  ...
                  clients.map((client) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 rounded-full bg-[#1e1839] flex items-center justify-center text-white text-xs font-bold">
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Groepen</h1>
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-[#1e1839] text-white text-sm font-medium rounded-lg hover:bg-[#2d2550] transition"
        >
      ...
      {groups.length === 0 ? (
        <div className="bg-white rounded-xl border p-12 text-center">
          ...
          <button
            onClick={() => setView("create")}
            className="px-4 py-2 bg-[#1e1839] text-white text-sm rounded-lg hover:bg-[#2d2550] transition"
          >
        ...
        <div className="space-y-3">
          {groups.map((group) => (
            <div
              key={group.id}
              className="bg-white rounded-xl border shadow-sm overflow-hidden hover:shadow-md transition cursor-pointer"
              ...
              <div className="px-5 py-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="p-2 text-gray-400 hover:text-[#1e1839] hover:bg-gray-100 rounded-lg transition"
                    title="Open chat"
                  >
