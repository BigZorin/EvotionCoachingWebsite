...
export default function DuoTrainingClientPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            <div className="space-y-6 lg:space-y-8">
              <div className="space-y-4 lg:space-y-6">
                ...
                <h1 className="text-3xl lg:text-6xl font-bold text-gray-900 leading-tight">
                  Duo Training - <span className="text-gray-700">Samen Sterker</span>
                </h1>
              ...
              <div className="grid grid-cols-3 gap-4 lg:gap-6 pt-6 lg:pt-8">
                <div className="text-center">
                  ...
                  <div className="text-xs md:text-sm text-gray-600">Motivatie</div>
                </div>
                <div className="text-center">
                  <div className="text-xl lg:text-3xl font-bold mb-1 text-gray-900">50%</div>
                  <div className="text-xs md:text-sm text-gray-600">Besparing p.p.</div>
                </div>
                <div className="text-center">
      ...
      <section className="py-12 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10 lg:mb-16">
            <Badge className="bg-gray-100 text-gray-700 border-gray-200 mb-4 lg:mb-6">
              <Target className="w-4 h-4 mr-2" />
              Voordelen
            </Badge>
            <h2 className="text-2xl lg:text-5xl font-bold text-gray-900 mb-4 lg:mb-6">
              Waarom Kiezen voor <span className="text-gray-700">Duo Training</span>?
            </h2>
            ...
            {benefits.map((benefit, index) => (
              <Card key={index} className="border border-gray-200 hover:shadow-lg transition-all duration-300">
                <CardContent className="p-4 lg:p-8 text-center space-y-2 lg:space-y-4">
                  <div className="w-12 h-12 lg:w-16 lg:h-16 bg-gray-100 rounded-xl lg:rounded-2xl flex items-center justify-center mx-auto">
                    <benefit.icon className="w-6 h-6 lg:w-8 lg:h-8 text-gray-700" />
                  </div>
                  <h3 className="text-base lg:text-xl font-bold text-gray-900">{benefit.title}</h3>
      ...
      <section className="py-12 lg:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10 lg:mb-16">
            ...
            <h2 className="text-2xl lg:text-5xl font-bold text-gray-900 mb-4 lg:mb-6">
              Starten met <span className="text-gray-700">Duo Training</span>
            </h2>
          </div>
            ...
            {[
              ...
              >
                <CardContent className="p-4 lg:p-6 space-y-3 lg:space-y-4">
                  <div className="w-12 h-12 lg:w-16 lg:h-16 bg-gray-900 rounded-full flex items-center justify-center mx-auto text-white">
                    <span className="text-base lg:text-xl font-bold">{item.step}</span>
                  </div>
                  <h3 className="text-base lg:text-xl font-bold text-gray-900">{item.title}</h3>
                  <p className="text-xs lg:text-base text-gray-600 leading-relaxed hidden sm:block">
                    {item.description}
                  </p>
                </CardContent>
      ...
      {/* Packages Section - Mobile Optimized, No Prices */}
      <section className="py-12 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10 lg:mb-16">
            <Badge className="bg-gray-100 text-gray-700 border-gray-200 mb-4 lg:mb-6">
            ...
            <h2 className="text-2xl lg:text-5xl font-bold text-gray-900 mb-4 lg:mb-6">
              Duo Training <span className="text-gray-700">Pakketten</span>
            </h2>
            <p className="text-sm lg:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
      ...
      <section className="py-12 lg:py-24 bg-gray-900 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl lg:text-5xl font-bold mb-4 lg:mb-6">
            Klaar om Samen te <span className="text-gray-300">Starten</span>?
          </h2>
          <p className="text-base lg:text-xl text-gray-300 max-w-2xl mx-auto mb-6 lg:mb-8">
