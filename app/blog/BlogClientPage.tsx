...
export function BlogClientPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-16 md:pt-20 py-24 px-4 bg-gradient-to-br from-[#1e1839] via-[#2d1b69] to-[#1e1839] overflow-hidden">
        {/* Background Pattern */}
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-[#bad4e1] rounded-full blur-3xl animate-pulse delay-500"></div>
        </div>

        <div className="relative max-w-7xl mx-auto text-center text-white z-10">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 mb-8 border border-white/20">
            <BookOpen className="w-5 h-5 text-[#bad4e1]" />
            <span className="text-sm font-semibold tracking-wide">EXPERT KNOWLEDGE HUB</span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 max-w-4xl mx-auto">
            <div className="flex flex-col items-center gap-3 bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              <div className="w-12 h-12 bg-[#bad4e1]/20 rounded-full flex items-center justify-center">
                <Target className="w-6 h-6 text-[#bad4e1]" />
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-[#bad4e1]">100+</div>
                <div className="text-sm text-gray-300">Expert Tips</div>
              </div>
            </div>

            <div className="flex flex-col items-center gap-3 bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              <div className="w-12 h-12 bg-[#bad4e1]/20 rounded-full flex items-center justify-center">
                <Award className="w-6 h-6 text-[#bad4e1]" />
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-[#bad4e1]">5+ Jaar</div>
                <div className="text-sm text-gray-300">Ervaring</div>
              </div>
            </div>

            <div className="flex flex-col items-center gap-3 bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              <div className="w-12 h-12 bg-[#bad4e1]/20 rounded-full flex items-center justify-center">
                <TrendingUp className="w-6 h-6 text-[#bad4e1]" />
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-[#bad4e1]">1000+</div>
                <div className="text-sm text-gray-300">Transformaties</div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-lg mx-auto mb-8">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-14 pr-6 py-5 text-lg bg-white/95 backdrop-blur-sm border-0 rounded-2xl shadow-2xl focus:ring-4 focus:ring-[#bad4e1]/30 focus:shadow-2xl transition-all duration-300"
              />
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              className="bg-[#bad4e1] hover:bg-[#bad4e1]/90 text-[#1e1839] rounded-full px-8 py-4 text-lg font-semibold shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
              asChild
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-2 border-white text-white hover:bg-white hover:text-[#1e1839] bg-transparent rounded-full px-8 py-4 text-lg font-semibold transition-all duration-300 hover:scale-105"
              asChild
            >
              <Link href="/contact">
                Gratis Consult
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <section id="categories" className="mb-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-5xl font-bold text-[#1e1839] mb-6">Expertise Gebieden</h2>
              ...
              <Link key={category.slug} href={`/blog/${category.slug}`} className="group">
                <Card className="h-full hover:shadow-2xl transition-all duration-500 group-hover:scale-105 border-0 bg-white shadow-lg hover:shadow-[#bad4e1]/20">
                  <CardHeader className="text-center pb-6">
                    <div
                      className={`w-20 h-20 ${category.color} rounded-2xl flex items-center justify-center text-3xl mx-auto mb-6 group-hover:scale-110 transition-all duration-300 shadow-lg text-white`}
                    >
                      {category.icon}
                    </div>
                    <CardTitle className="text-xl font-bold text-[#1e1839] group-hover:text-[#bad4e1] transition-colors">
                      {category.name}
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="text-center">
                    ...
                    <div className="flex items-center justify-center gap-3">
                      <Badge variant="outline" className="border-[#1e1839]/20 text-[#1e1839] text-sm px-3 py-1">
                        {blogArticles.filter((article) => article.category.slug === category.slug).length} artikelen
                      </Badge>
                      <ArrowRight className="w-4 h-4 text-gray-400 group-hover:text-[#bad4e1] group-hover:translate-x-2 transition-all duration-300" />
                    </div>
                  </CardContent>
                </Card>
              </Link>
        ...
        {blogArticles.length > 0 && (
          <section className="mb-16">
            <Card className="bg-gradient-to-r from-gray-50 to-white border border-gray-200 shadow-lg">
              <CardHeader>
                <CardTitle className="flex items-center gap-3 text-[#1e1839] text-xl">
        ...
        <section className="relative py-20 px-8 bg-gradient-to-r from-[#1e1839] to-[#2d1b69] rounded-2xl text-white text-center overflow-hidden">
          {/* Background Elements */}
